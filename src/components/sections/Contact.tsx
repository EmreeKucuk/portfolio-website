    ...
    >
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 md:px-12 w-full">
        ...
        <div className="flex items-center gap-6 mb-16">
          <span className="font-mono text-xs text-muted tracking-widest">04</span>
        ...
        <div className="grid lg:grid-cols-2 gap-16 lg:gap-24">
          ...
          <div>
            ...
            <p className="text-body-lg text-muted max-w-lg mb-12">
              Open to discussing new projects, creative collaborations, or opportunities 
          ...
          <div ref={contentRef} className="space-y-12">
            ...
            <div className="contact-item grid grid-cols-2 gap-8 pt-8">
              <div>
                <p className="font-mono text-xs text-muted tracking-widest uppercase mb-2">Location</p>
                <p className="text-highlight">Istanbul, Turkey</p>
              </div>
              <div>
                <p className="font-mono text-xs text-muted tracking-widest uppercase mb-2">Local Time</p>
                <p className="text-highlight font-mono">{time} <span className="text-muted">TRT</span></p>
              </div>
            </div>
          </div>
        </div>
        ...
        <footer className="mt-32 pt-12 border-t border-white/10">
          <div className="flex flex-col md:flex-row justify-between items-center gap-6">
            <p className="text-sm text-muted">
              © {new Date().getFullYear()} Emre Küçük. Engineered with precision.
            </p>
